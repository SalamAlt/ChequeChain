...
describe('Wallet', () => {
	...
	it('has a `balance`', () => {
		expect(wallet).toHaveProperty('balance'); //checks to see if wallet instanace has a property called balance
	});
	...
	describe('calculatedBalance()', () => {
		...
		describe('and there are outputs for the wallet', () => {
			...
			it('adds the sum of all outputs to the wallet balance', () => {
				expect(
					Wallet.calculateBalance({ 
						...
						transactionTwo.outputMap[transactionTwo]
					)
				});
			});
			...
			describe('and the wallet has made a transaction', () => {
				...
				describe('and there outputs next to and after the recent transaction', () => {
					...
					sameBlockTransaction = Transaction.rewardTransaction({ minerWaller: wallet });
