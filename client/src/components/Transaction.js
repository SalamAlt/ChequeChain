...
const Transaction = ({ transaction })  => {
    const { input, outputMap, chequeID, transitNumber, institutionNumber, accountNumber, clientName, date } = transaction;//make sure to add variables being grabbed from transaction
    ...
    return (
        <div className='Transaction'>
            ...
            <div>Cheque Date: {new Date(date).toLocaleString()}</div>
