...
describe('Blockchain()', () => {
	...
	beforeEach(() => { //creates a new instance of a blockchain between each test
	...
	describe('isValidChain()', () =>{
		...
		describe('when the chain does not start with the genesis block', () => {
			it('returns false', () => {
				...
				expect(Blockchain.isValidChain(blockchain.chain)).toBe(false); //call Blockchain class and function isValidChain pass chain array as param
			});
		});
	...
	describe('replaceChain()', () => {
		...
		describe('and the `vaildateTransactions` flag is true', () => {
	...
	describe('validTransactionData()', () => {
		...
		describe('and the transaction data has at least on malformed outputMap', () => {
