...
class PubSub {
	...
	subscribeToChannels(){
		Object.values(CHANNELS).forEach(channel => { //object.values gets all channels from channels
			this.subscriber.subscribe(channel); //subcribe to all channels using loop
		});
	}
